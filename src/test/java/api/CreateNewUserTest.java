...
public class CreateNewUserTest {
    ...
    @Test
    public void testCreateNewUserWithValidData() throws IOException {
        ...
        Assert.assertTrue(entity.contains("\"email\":\""+userEmail+"\""));
        Assert.assertTrue(entity.contains("\"name\":\""+userName+"\""));
