...
public class TitleTaskPage {
    ...
    public static final String EXPECTED_PAGE_HEADING_TITLE = "Добавление задачи";
    public static final String EXPECTED_FIELD_TASK_NAME_TITLE = "Название задачи";
    public static final String EXPECTED_FIELD_RESPONSIBLE_TITLE = "Ответственный";
    public static final String EXPECTED_FIELD_DESCRIPTION_TITLE = "Описание задачи";
    public static final String EXPECTED_BUTTON_ADD_TASK_TITLE = "";

    // Title for EditTaskPageTest
    public static final String EXPECTED_PAGE_EDIT_HEADING_TITLE = "Редактирование задачи";
    public static final String EXPECTED_FIELD_TASK_EDIT_NAME_TITLE = "Название задачи";
